...
<template>
  ...
  <p>Não precisa se preocupar tanto em relação a isso, pois basicamente o Vue.js faz toda essa manipulação de DOM e Virtual DOM pra nós. Com isso, evita-se problemas referentes a manipulação do DOM, mas não é impossível de ocorrer. * Estudar mais</p>
</template>
